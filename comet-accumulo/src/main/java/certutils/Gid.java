...
public class Gid {
    ...
    void decode() throws CertificateException {
        ...
        while (itr.hasNext()) {
            ...
            if (alternativeName.toLowerCase().startsWith("urn:uuid:")) {
                ...
                this.uuid = UUID
                        .fromString(alternativeName.substring(alternativeName.length() - 36, alternativeName.length()));
    ...
    void setHrnAndType(String urn) throws CertificateException {
        ...
        if (type.equals("authority")) {
            ...
            // Drop the sa. This is a bad hack, but its either this or completely change how record types are
            // generated/stored
            if (!name.equals("sa")) {
                type = type + "+" + name;
            }
    ...
    public void verifyCertChain(String trustKeyStorePath, String keyStorePassword)
        ...
        X509Certificate trustAnchor = CertificateUtil.verifyCertChain(this.certificateChain, trustKeyStorePath,
                keyStorePassword);
    ...
    /*
     * public List<X509Certificate> getCertificateChain(){ return this.certificateChain; }
     */
