...
@Api(value = "readScope", description = "the readScope API")
public interface ReadScopeApi {

    @ApiOperation(value = "Retrieve a value from a named scope within a context.  ", nickname = "readScopeGet", notes = "Retrieve a value from a named scope within a context.  - Operation requires read access  Need to distinguish the following situations: - The scope value is null - The scope existed, but was deleted - The scope never existed (for the period of garbage collection) - Scope visibility doesn’t match ", response = CometResponse.class, authorizations = {
